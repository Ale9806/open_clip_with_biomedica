...
srun torchrun --nproc_per_node={NUM_GPUS} --nnodes={NUM_NODES} --node_rank=$SLURM_NODEID --rdzv_id {RDZV_ID} --rdzv_backend c10d --rdzv_endpoint $head_node_ip:{RDZV_PORT} -m open_clip_train.main \
    --save-most-recent \
     --train-data "/pasteur2/u/ale9806/data/pmc-oa/full_panel_w_labels/commercial/{{000000..001263}}.tar::/pasteur2/u/ale9806/data/pmc-oa/full_panel_w_labels/noncommercial/{{000000..000533}}.tar::/pasteur2/u/ale9806/data/pmc-oa/full_panel_w_labels/other/{{000000..000110}}.tar" \
    --train-num-samples 19060000 \
    --accum-freq 4 \
    --lr-scheduler "cosine" \
